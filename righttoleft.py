...
# Loop indefinitely
while True:
    # Move to the adjusted position on the right
    pyautogui.moveTo(end_offset, screen_height/2)
    
    # Click and hold
    pyautogui.mouseDown()
    
    # Drag to the adjusted position on the left
    pyautogui.moveTo(start_offset, screen_height/2, duration=0.15)
    ...
    # If it's the 50th iteration, sleep for 6 seconds
    if counter % 50 == 0:
        time.sleep(6)
